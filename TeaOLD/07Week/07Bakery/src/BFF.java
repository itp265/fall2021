...
public class BFF
{
    ...
    public Issuer getCardIssuer(){
         String card = inputLine("Who is the credit card issuer? Type: " + Arrays.asList(Issuer.values()));
        Issuer issuer = Issuer.valueOf(card.toUpperCase());
        return issuer;
    }
    public CreditCard inputCreditCardInfo(){
        String name = inputLine("What is the full name on credit card?");
        Issuer issuer = getCardIssuer();
