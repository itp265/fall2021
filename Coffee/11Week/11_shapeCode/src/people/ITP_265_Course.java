...
public class ITP_265_Course {
	...
	private ArrayList<Student> owlStudents;
	...
	private void makeTAs() {
		allPeople.add(new StudentTA("Cat", 1998, 12, 27, 4.0, "CS", "ITP-265"));
		allPeople.add(new StudentTA("Phil", 1998, 4, 18, 4.0, "ME", "ITP-265"));
		allPeople.add(new StudentTA("Malik", 1997, 9, 6, 4.0, "ME", "ITP-265"));
		allPeople.add(new StudentTA("Kamryn", 1999, 4, 3, 4.0, "Neuro", "ITP-265"));
		allPeople.add(new StudentTA("Walter", 1999, 11, 23, 4.0, "Accounting", "ITP-265"));
		allPeople.add(new StudentTA("Anup", 1997, 7, 26, 4.0, "CS", "ITP-265"));
		allPeople.add(new StudentTA("Adam", 1999, 12, 21, 4.0, "BUAD", "ITP-265"));
	...
	public static void main(String[] args) {
		...
		//c.run();
		c.addFakeData();
		ArrayList<Person> people = c.allPeople;
		for(Person p: people) {
		...
		Collections.sort(people); //for lists
		...
		Person n = new Student("Nicholas", 2000, 8, 8, 4.0, "Pyschology");
		Student s = (Student)n; 
		//Student ta = (StudentTA)n;  //NOT ALLOWED
		// n = new StudentTA(studentObj, "itp-265")
		n = new StudentTA(n.getName(), s.getBday(), s.getGpa(), s.getMajor(), "ITP-265");
		Person ta = (StudentTA)n;
		System.out.println("Here is my student: " + n);
